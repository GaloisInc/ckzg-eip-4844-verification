...
\newcommand{\tht}[1]{\footnote{\textcolor{brown}{THT: #1}}}
...
\begin{enumerate}
    ...
    \item A \href{https://github.com/GaloisInc/ckzg-eip-4844-verification/tree/main/spec/TestVectors}{test bench}
          ...
          \tht{Can you please add more details how the test bench were generated and selected?}
...
\begin{enumerate}
    \item The BLS helper function \texttt{hash\_to\_bls\_field} is currently a placeholder
          \begin{enumerate}
                ...
                \tht{It is good to provide some ideas whether Cryptol is enough expressive to specify a SHA2-256 implementation.}
          \end{enumerate}
...
Because the Cryptol specification took longer than anticipated
\tht{Can you please describes challenges in writing the Crypto specification that make it longer than expected?}
, we were only able to use SAW to formally verify
...
\href{https://link.springer.com/chapter/10.1007/978-3-030-76384-8_5}{SPIN 2022}).
\tht{It seems a typo as both links are the same.}
...
\begin{enumerate}
    \item Create a SAW proof to show equivalence between a c-kzg function F and its corresponding Cryptol specification function S.
          ...
          \end{enumerate}
    \item Repeat 1 and 2
      \tht{It looks like an infinite loop as we are at 2 and need to repeat 2}
      for next function to formally verify 
\end{enumerate}
...
library using SAW.
\tht{Do you have any idea of the estimated time to completely verify the c-kzg implementation?}
