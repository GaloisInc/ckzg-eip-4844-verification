...
\newcommand{\RS}[1]{\textcolor{red}{\footnotemark}\footnotetext{\color{red}RS: #1}}
...
specification through some proofs\RS{Do we have actual proofs showing correctness of the Cryptol specification?}, a test bench, and visual inspection; and, finally, create proofs in
...
our purposes\RS{It would be good to explain why this was the case and why we needed to specify BlsEC given that, as far as I understand it, we have not proven any of the functions requring BLS}. Thus, we had to create all of the code in
...
for the level of effort required to completely verify the c-kzg implementation.\RS{It would be good to provide an indication of how long this would take.}
